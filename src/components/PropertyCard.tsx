      ...
      <div className="p-4 flex flex-col gap-2 relative">
        <div className="flex items-center justify-between mb-2 flex-wrap sm:flex-nowrap">
          <div className="flex items-center gap-3">
            ...
            <span
              className="text-black text-[18px] sm:text-[20px] md:text-[24px] font-medium"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-4 gap-2">
          ...
          <button
            className="bg-[#1E3A8A] text-white text-[12px] sm:text-[14px] font-semibold px-4 py-2 rounded-[31px] mt-2 sm:mt-0"
            style={{ fontFamily: "Poppins" }}
          >
            Know More
          </button>
